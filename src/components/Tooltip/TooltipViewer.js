        ...
        <div className="clearfix">
          ...
          <div className="ims-tooltip-content">
            {this.props.tooltip.content && (
              <ReactMarkdown source={this.props.tooltip.content || ''} />
            )}
            {this.props.tooltip.link && (
              <a href={this.props.tooltip.link} target="_blank">
                more info
              </a>
            )}
          </div>
  ...
  renderEditButton() {
    return (
      <a
        ...
        onClick={() => this.props.onEdit(this.props.tooltip)}>
