  ...
  render() {
    return (
      <Modal isOpen toggle={this.props.onCancel}>
        {this.props.header ? <ModalHeader closeButton>{this.props.header}</ModalHeader> : null}
        <ModalBody>{this.props.actionMessage}</ModalBody>
        <ModalFooter>
          ...
          <button
            type="button"
            className={this.props.confirmButtonClassNames || 'btn btn-primary'}
